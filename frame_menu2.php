    ...
    <ul id="dropmenu">
        ...
        <li><a>観光支援</a>
            <ul>
                ...
                <li><a href="tourism_record_edit.php">観光を行う</a></li>
            </ul>
        </li>

        <li><a>一覧</a>
            <ul>
                <li><a href="all_spots_view.php">スポット一覧</a></li>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a>観光支援</a>
                                <ul>
                                    ...
                                    <li class="nav-item"><a href="tourism_record_edit.php">観光を行う</a></li>
                                </ul>
                            </li>

                            <li class="nav-item"><a>一覧</a>
                                <ul>
                                    <li class="nav-item"><a href="all_spots_view.php">スポット一覧</a></li>
                                    <li class="nav-item"><a href="users_plans.php">他のユーザーが作成した観光計画</a></li>
                                </ul>
                            </li>
